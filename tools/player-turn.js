...
async function executePlayerTurn({ run, mode = run.profile_id, provider, narration_provider = null, player_text, request_id, context = null, consequenceResolver = null, sceneBuilder = null }) {
  const natural = await executeNatural({ run, provider, player_text, request_id, context, consequenceResolver });
