...
for (const required of [node, launcher, path.join(artifact, "app", "tools", "ai-openai-provider.js"), path.join(artifact, "app", "tools", "procedural-complex.js"), path.join(artifact, "app", "tools", "world-history.js"), path.join(artifact, "app", "tools", "becks-desk.js"), path.join(artifact, "app", "tools", "nullzone-exposure.js"), path.join(artifact, "app", "data", "procedural-grammar.json"), path.join(artifact, "app", "node_modules", "custodian", "index.js"), path.join(artifact, "app", "node_modules", "openai", "index.js"), path.join(artifact, "app", "START-HERE.md"), path.join(artifact, "app", "LICENSE"), path.join(artifact, "app", "THIRD_PARTY_NOTICES.md")]) assert.ok(fs.existsSync(required), `missing ${required}`);
