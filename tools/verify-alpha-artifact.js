...
for (const required of [node, launcher, path.join(artifact, "app", "tools", "ai-openai-provider.js"), path.join(artifact, "app", "tools", "procedural-complex.js"), path.join(artifact, "app", "tools", "procedural-complex-v2.js"), path.join(artifact, "app", "tools", "environment-world.js"), path.join(artifact, "app", "tools", "world-history.js"), path.join(artifact, "app", "tools", "entity-simulation.js"), path.join(artifact, "app", "tools", "becks-desk.js"), path.join(artifact, "app", "tools", "nullzone-exposure.js"), path.join(artifact, "app", "tools", "lost.js"), path.join(artifact, "app", "tools", "gameplay.js"), path.join(artifact, "app", "tools", "q4-equipment.js"), path.join(artifact, "app", "tools", "spatial-runtime.js"), path.join(artifact, "app", "tools", "object-runtime.js"), path.join(artifact, "app", "tools", "mission-runtime.js"), path.join(artifact, "app", "data", "procedural-grammar.json"), path.join(artifact, "app", "data", "entity-definitions.json"), path.join(artifact, "app", "data", "still-life-behavior-authority.json"), path.join(artifact, "app", "data", "worldpacks", "clear-q4", "mission.json"), path.join(artifact, "app", "canon", "operational-mission-schema.json"), path.join(artifact, "app", "node_modules", "custodian", "index.js"), path.join(artifact, "app", "node_modules", "openai", "index.js"), path.join(artifact, "app", "START-HERE.md"), path.join(artifact, "app", "LICENSE"), path.join(artifact, "app", "THIRD_PARTY_NOTICES.md")]) assert.ok(fs.existsSync(required), `missing ${required}`);
...
const entityRuntime = spawnSync(node, ["-e", "const entity=require('./tools/entity-simulation'); console.log(JSON.stringify({version:entity.VERSION,projection:entity.PROJECTION_VERSION,definitions:entity.definitions.definitions.length}))"], { encoding: "utf8", cwd: path.join(artifact, "app") }); assert.equal(entityRuntime.status, 0, entityRuntime.stderr); assert.deepEqual(JSON.parse(entityRuntime.stdout), { version: "yellow-beast-entity-simulation@v1", projection: "yellow-beast-entity-projection@v1", definitions: 2 });
const gameplayRuntime = spawnSync(node, ["-e", "const gameplay=require('./tools/gameplay'); console.log(JSON.stringify({version:gameplay.VERSION,projection:gameplay.PROJECTION_VERSION}))"], { encoding: "utf8", cwd: path.join(artifact, "app") }); assert.equal(gameplayRuntime.status, 0, gameplayRuntime.stderr); assert.deepEqual(JSON.parse(gameplayRuntime.stdout), { version: "yellow-beast-gameplay@v1", projection: "yellow-beast-gameplay-projection@v1" });
const missionRuntime = spawnSync(node, ["-e", "const bootstrap=require('./tools/run-bootstrap'); const mission=bootstrap.missionDefinitionFor('clear-q4'); console.log(JSON.stringify({version:mission.version,mission:mission.mission.id,objectives:mission.mission.objectives.length}))"], { encoding: "utf8", cwd: path.join(artifact, "app") }); assert.equal(missionRuntime.status, 0, missionRuntime.stderr); assert.deepEqual(JSON.parse(missionRuntime.stdout), { version: "yellow-beast-mission-worldpack@v1", mission: "clear-q4-field-assignment", objectives: 9 });
