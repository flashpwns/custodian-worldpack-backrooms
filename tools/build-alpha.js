...
["manifest.json", "LICENSE", "THIRD_PARTY_NOTICES.md", "START-HERE.md", "package.json", "profiles", "scenarios/threshold-baseline.json", "data", "canon/operational-spatial-schema.json", "canon/operational-interaction-schema.json", "canon/operational-mission-schema.json", "canon/operational-dynamics-schema.json", "canon/operational-logistics-schema.json", "canon/institutional-response-schema.json", "canon/complete-operation-schema.json", "node_modules"].forEach(copy);
