...
Pass 2 retained that boundary: the currently exposed ASYNC staff are explicitly anonymous procedural role occupants (`pack-original-human-glue`). They persist through the desk state and may be assigned, unavailable, or replaced, but are never represented as an invented canon cast.
