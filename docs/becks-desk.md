...
The Beck-safe projection includes institutional reports, known regions, roster availability, teams, operations, resource counts, budget, research, infrastructure, and delayed/delivered reports. It excludes raw events, objective field state, unseen topology, civilian records, and unreported observations.
