...
scripts.push("tests/y31-dev-workflow.test.js", "tools/dev-inspection.js", "tools/dev-workflow-report.js");
scripts.push("tests/y31-dev-console.test.js", "tools/dev-console-report.js");
scripts.push("tests/y31-dev-commands.test.js", "tools/dev-commands.js", "tools/dev.js", "tools/dev-command-report.js");
scripts.push("tests/y31-authoring.test.js", "tools/authoring.js", "tools/authoring-report.js");
scripts.push("tests/y31-performance.test.js", "tools/performance-report.js");
scripts.push("tests/y31-closure.test.js", "tools/y31-closure-report.js");
...
scripts.push("tests/y33-long-world-torture.test.js", "tools/yb33-torture-report.js");
scripts.push("tests/y34-beta-hotfix.test.js");
scripts.push("tests/y35-product-focus.test.js");
...
scripts.push("tools/personnel-generation.js", "tools/operational-dynamics.js", "tools/operational-time.js", "tools/communication-runtime.js", "tools/team-runtime.js", "tools/hazard-runtime.js", "tools/consequence-runtime.js", "tools/operational-cycle.js");
scripts.push("tests/y36-q4-channels.test.js");
scripts.push("tests/y37-q4-personnel.test.js");
scripts.push("tests/y38-q4-equipment.test.js");
scripts.push("tests/y39-q4-missions.test.js");
scripts.push("tests/y40-q4-trajectories.test.js");
...
// Explicitly reconciled application and regression scripts. Keep this list closed.
scripts.push(
  "desktop/hosted-ai-smoke.js",
  "tests/v03-persistence-foundation.js",
  "tests/y69-reference-expedition.test.js",
  "tests/y70-coordinated-execution.test.js",
  "tests/y71-ai-interpreter-boundary.test.js",
  "tests/y72-live-scene-projection.test.js",
  ...
  "tests/y79-clause-completeness-coordinated.test.js",
  "tests/y80-canonical-ledger-observer-shell.test.js",
  "tests/y81-canonical-ledger-epistemic-hardening.test.js",
  "tests/y82-reference-expedition-vertical-blockers.test.js",
  "tests/y83-natural-command-transactions.test.js",
  "tools/ai-hosted-transport.js",
  "tools/ai-interpreter-boundary.js",
  "tools/ai-living-provider.js",
  "tools/ai-living-turn.js",
  "tools/ai-local-dialogue.js",
  "tools/ai-provider-pool.js",
  "tools/canonical-world-ledger.js",
  "tools/custodian-ai-host-adapter.js",
  "tools/desktop-artifact-paths.js",
  "tools/live-scene-projection.js",
  "tools/reference-expedition.js",
  "tools/referent-resolution.js",
  "tools/observer-context-compiler.js",
  "tests/y83-ai-runtime-stability.test.js",
  "tests/y84-hybrid-canon-hardening.test.js",
  "tools/affordance-service.js",
  "tools/canon-lexicon.js",
  "tools/canon-linter.js",
  "tools/communication-routing.js",
  "tools/field-notes.js",
  "tools/interpretive-director.js",
  "tools/perception-service.js",
  "tests/y79-canonical-world-ledger-invariants.test.js"
);
// Scripts added since the last inventory reconciliation (dialogue engine, local runtime, opener and
// their tests). Each one is still subject to the public-Custodian-import check below.
scripts.push("desktop/menu-music.js", "desktop/renderer/cinematic-player.js", "desktop/renderer/dialogue-player.js", "desktop/renderer/ending.js", "desktop/renderer/title-player.js", "desktop/runtime-smoke.js", "desktop/shared/cinematic-registry.js", "desktop/shared/name-rules.js", "desktop/visual-acceptance-smoke.js", "tests/ed1-dialogue-discourse.test.js", "tests/ed15-dialogue-blockers.test.js", "tests/ed16-dialogue-closure.test.js", "tests/ed2-semantic-enforcement.test.js", "tests/ed21-validation-clean.test.js", "tests/ed22-context-bridge.test.js", "tests/ed23-provider-runtime.test.js", "tests/ed24-freeze-invariants.test.js", "tests/ed25-human-acceptance-dialogue.test.js", "tests/ed26-conversation-semantics.test.js", "tests/ed27-conversational-pragmatics.test.js", "tests/ed28-semantic-knowledge.test.js", "tests/ed29-day1-knowledge-convergence.test.js", "tests/ed3-local-runtime-dev.test.js", "tests/ed4-dialogue-reconciliation.test.js", "tests/ed5-autonomous-and-known-answer.test.js", "tests/y100-cinematic-registry.test.js", "tests/y101-broadcast-to-briefing.test.js", "tests/y102-managed-inference-appliance.test.js", "tests/y103-beat1-implementation.test.js", "tests/y104-clean-workstation-handoff.test.js", "tests/y105-authoritative-first-run-chronology.test.js", "tests/y106-physical-maxwell-briefing.test.js", "tests/y107-authored-cinematic-assets-and-esc-skip.test.js", "tests/y108-beat-2-4-convergence-repair.test.js", "tests/y109-local-coworker-dialogue-runtime.test.js", "tests/y110-dialogue-interpretation.test.js", "tests/y111-local-group-dialogue-pass.test.js", "tests/y166-dialogue-runtime-supervisor.test.js", "tests/y167-cinematic-warmup-skip-gate.test.js", "tests/y168-observation-authority.test.js", "tests/y169-observation-persistence-integration.test.js", "tests/y170-speech-scheduler.test.js", "tests/y171-autonomous-speech-live.test.js", "tests/y172-autonomous-speech-turn-safety.test.js", "tests/y173-autonomous-speech-refresh.test.js", "tests/y174-autonomous-report-rendering.test.js", "tests/y85-negation-aware-onboarding.test.js", "tests/y85-transactional-persistence-failpoints.test.js", "tests/y86-adversarial-semantic-commands.test.js", "tests/y87-live-scenarios-a-k.test.js", "tests/y88-actor-behavioral-state.test.js", "tests/y88-actor-multi-turn-behavioral.test.js", "tests/y89-consequence-cascade-proof.test.js", "tests/y89-presentation-bus-wiring.test.js", "tests/y90-expedition-script-30turn.test.js", "tests/y91-cq4-day1-opener-core.test.js", "tests/y92-cq4-day1-geography-delivery.test.js", "tests/y93-cq4-day1-cold-boot-persistence.test.js", "tests/y94-cq4-day1-adversarial-corrective.test.js", "tests/y95-map-provenance-and-restart.test.js", "tests/y96-comms-targeting-and-absent-recipients.test.js", "tests/y97-local-model-provider.test.js", "tests/y98-opening-beats-1-4.test.js", "tests/y99-cq4-day1-beatmap-conformance.test.js", "tools/acoustic-director.js", "tools/adversarial-certification-suite.js", "tools/ai-local-model-provider.js", "tools/canonical-knowledge.js", "tools/cinematic-registry.js", "tools/cq4-day1-opener.js", "tools/decision-scheduler.js", "tools/demonstrate-dialogue-and-interpretation.js", "tools/dialogue-advisory-interpreter.js", "tools/dialogue-discourse.js", "tools/dialogue-fallback.js", "tools/dialogue-interpretation.js", "tools/dialogue-prompt-contract.js", "tools/dialogue-runtime-supervisor.js", "tools/dialogue-validation.js", "tools/fetch-runtime-resources.js", "tools/local-install-dev.js", "tools/managed-inference-appliance.js", "tools/measure-performance-metrics.js", "tools/observation-authority.js", "tools/presentation-bus.js", "tools/probe-broader-gameplay.js", "tools/probe-day1-opener-walkthrough.js", "tools/prove-dialogue-regression.js", "tools/reconcile-verification-inventory.js", "tools/report-pdf.js", "tools/run-visual-traversal.js", "tools/spatial-event-contract.js", "tools/speech-scheduler.js", "tools/stage-runtime-resources.js", "tools/verify-live-provider-acceptance.js", "tools/verify-local-model-acceptance.js", "tools/verify-visual-acceptance.js");
