...
const DEFAULT_SETTINGS = Object.freeze({ version: 4, input_mode: "structured", provider: "offline", theme: "system", text_scale:"default", reduced_motion: false, guided_introductions: true, reopen_last_world: true, mode_onboarding: {}, visual_rendering: true, visual_adapter: "fallback", visual_quality: "documentary", automatic_evidence_rendering: true, retry_failed_renders: true, media_effect_intensity: "restrained", comfyui_endpoint: "http://127.0.0.1:8188", comfyui_workflow: "observer-safe-q4-evidence" });
